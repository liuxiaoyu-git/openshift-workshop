...
NOTE: Please replace <prod-namespace-prod-cluster> and <kafka-namespace-dev-cluster> with the namespace where the namespace where your app is running on prod cluster, respectevely to the namespace where Kafka runs on Dev cluster
...
metadata:
  name: quarkus-config
  namespace: <prod-namespace-prod-cluster>
data:
  application.properties: >-
    ...
    %prod.mp.messaging.outgoing.generated-name.bootstrap.servers=names-cluster-kafka-bootstrap-kafka.<kafka-namespace-dev-cluster>.apps.pro1.mattiamascia.com:9094
    ...
    %prod.mp.messaging.incoming.names.bootstrap.servers=names-cluster-kafka-bootstrap-kafka.<kafka-namespace-dev-cluster>.apps.pro1.mattiamascia.com:9094
